      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl shadow-black/30">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full bg-white text-slate-800 font-semibold py-3 px-4 rounded-xl hover:bg-slate-100 transition shadow-sm cursor-pointer"
          >
